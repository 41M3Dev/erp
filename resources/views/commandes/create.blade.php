...
@section('title', 'Nouvelle commande — ERP')
...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-xl font-semibold text-slate-900">Nouvelle commande</h1>
        </div>
            ...
            <form action="{{ route('commandes.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="reference_commande" name="reference_commande"
                        value="{{ old('reference_commande') }}" required class="{{ $input }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div>
                        ...
                        <input type="date" id="date_livraison" name="date_livraison"
                            value="{{ old('date_livraison') }}" class="{{ $input }}">
