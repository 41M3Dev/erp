...
@section('title', 'Nouveau produit — ERP')
...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-xl font-semibold text-slate-900">Nouveau produit</h1>
        </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div>
                        ...
                        <input type="number" step="0.01" id="prix_achat" name="prix_achat"
                            value="{{ old('prix_achat') }}" class="{{ $input }}">
                        @error('prix_achat')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="number" step="0.01" id="prix_vente" name="prix_vente"
                            value="{{ old('prix_vente') }}" class="{{ $input }}">
                        @error('prix_vente')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
